...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean BoxCreate
        {
            get
            {
                return SteamVR_Actions.default_BoxCreate;
            }
        }
        
        public virtual SteamVR_Action_Vector2 SelectBox
        {
            get
            {
                return SteamVR_Actions.default_SelectBox;
            }
        }
        
        public virtual SteamVR_Action_Boolean ScrollLeft
        {
            get
            {
                return SteamVR_Actions.default_ScrollLeft;
            }
        }
        
        public virtual SteamVR_Action_Boolean ScrollRight
        {
            get
            {
                return SteamVR_Actions.default_ScrollRight;
            }
        }
        
        public virtual SteamVR_Action_Boolean RemoveBox
        {
            get
            {
                return SteamVR_Actions.default_RemoveBox;
            }
        }
